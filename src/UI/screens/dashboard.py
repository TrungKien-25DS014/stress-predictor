"""
DashboardScreen – Phần 1 + 2 hoàn chỉnh
File: src/ui/screens/dashboard.py

Tái sử dụng:
  • MetricCard  ← src/ui/components/custom_widgets.py
  • CanvasChart ← src/ui/components/canvas_chart.py
"""
...
# ── Tái sử dụng widget từ dự án ─────────────────────────────────────────────
from src.UI.components.custom_widgets import MetricCard
from src.UI.components.canvas_chart   import CanvasChart
...
class DashboardScreen(QWidget):
    """
    Màn hình Dashboard chính – Stress Predictor.

    Layout (QVBoxLayout chính):
      ┌─────────────────────────────────────────────────────────┐
      │  TOP BAR  (QLabel – "Dashboard")                        │
      ├──────────┬──────────┬──────────┬───────────────────────┤
      │ Tổng test│ Test/Tháng│ TB Stress│ Gần nhất             │
      ├──────────────────────────────┬──────────────────────────┤
      │  MIDDLE LEFT  (65%)          │  MIDDLE RIGHT (35%)      │
      │  CanvasChart                 │  QCalendarWidget         │
      │                              │  QLabel tip sức khoẻ     │
      ├──────────────────────────────┴──────────────────────────┤
      │  BOTTOM  –  QTableWidget nhật ký                        │
      └─────────────────────────────────────────────────────────┘
    """
